      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Krishna Chavan</h2>
            <p className="text-sm">© 2024 Cloud Counsulage Pvt Ltd. All rights reserved.</p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-400" aria-label="LinkedIn">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="https://www.linkedin.com/company/cloud-counselage/posts/?feedView=all" /></svg>
            </a>
          </div>
        </div>
      </div>
